...
<!-- 错误：<p> 未闭合 -->
<div>
  <p>paragraph <span>span content</span></p>
</div>
```
...
```
{
  ...
  errors: [
    { code: X_MISSING_ATTRIBUTE_VALUE, loc: {...} },
    { code: X_MISSING_INTERPOLATION_END, loc: {...} },
    { code: X_V_IF_NO_EXPRESSION, loc: {...} },
    { code: X_V_FOR_MALFORMED_EXPRESSION, loc: {...} }
  ]
}
```
