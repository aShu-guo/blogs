...
<div
:
data - test.camel.prop = "value" > </div>
...
<div
:
[computedAttr] = "value" > </div>

  // ✅ 推荐
  < div
v - bind = "computedAttrs" > </div>

  // 3. 修饰符组合顺序无关
  < div
:
prop.camel.attr = "val" > </div>  /
/ 等价于
< div
:
prop.attr.camel = "val" > </div>  /
/ 处理顺序固定
```
