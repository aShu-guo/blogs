...
### [7.2 错误追踪](./7-2-error-tracking.md) ⭐⭐⭐
...
### [7.3 用户体验监控](./7-3-ux-monitoring.md) ⭐⭐
...
### [7.4 性能预算](./7-4-performance-budget.md) ⭐⭐
...
### 新手路径
1. 先学习 [7.1 性能监控体系](./7-1-monitoring.md)，掌握数据采集
2. 再学习 [7.2 错误追踪](./7-2-error-tracking.md)，建立错误监控
3. 最后学习 [7.4 性能预算](./7-4-performance-budget.md)，设置阈值

### 进阶路径
1. 深入学习 [7.3 用户体验监控](./7-3-ux-monitoring.md)，分析真实用户
2. 结合性能预算与报警，将监控接入 CI/CD
3. 在地图/视频/大屏场景落地自定义指标
