...
### [5.6 资源压缩与传输](./5-6-compression.md) ⭐⭐⭐
...
2. 再学习 [5.6 资源压缩与传输](./5-6-compression.md)，优化传输效率
3. 最后学习 [5.3 视频优化](./5-3-video.md)，处理大型资源

### 进阶路径
1. 深入学习 [5.4 SVG 优化](./5-4-svg.md)，掌握矢量图优化
2. 结合 [5.2 字体优化](./5-2-fonts.md)，优化文字渲染
3. 学习 [5.5 音频优化](./5-5-audio.md)，完善多媒体优化
