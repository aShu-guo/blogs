...
### [6.2 Tree Shaking](./6-2-tree-shaking.md) ⭐⭐
...
2. 再学习 [6.2 Tree Shaking](./6-2-tree-shaking.md)，消除无用代码
3. 最后学习 [6.3 压缩与混淆](./6-3-minification.md)，减小产物

### 进阶路径
1. 深入学习 [6.4 构建分析](./6-4-analysis.md)，定位大包/重复依赖
2. 结合 Vite 配置与分包策略，持续迭代拆分
3. 在 CI 中加入体积门槛与可视化报告
