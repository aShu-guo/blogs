...
### [3.1 重排与重绘优化](./3-1-reflow-repaint.md) ⭐⭐⭐
...
### 新手路径
1. 先学习 [3.1 重排与重绘优化](./3-1-reflow-repaint.md)，理解渲染基础
2. 再学习 [3.5 事件处理优化](./3-5-events.md)，优化交互性能
3. 最后学习 [3.3 长列表优化](./3-3-long-list.md)，解决实际问题

### 进阶路径
1. 深入学习 [3.2 合成层优化](./3-2-composite.md)，掌握高级技巧
2. 结合 [3.4 动画性能优化](./3-4-animation.md)，打造流畅动画
3. 学习 [3.6 内存管理](./3-6-memory.md)，避免内存问题
