...
### [4.1 Vue 3 编译优化](./4-1-vue-compile.md) ⭐⭐⭐
...
### [4.2 Vue 3 运行时优化](./4-2-vue-runtime.md) ⭐⭐⭐
...
### [4.3 虚拟列表与虚拟滚动](./4-3-virtual-list.md) ⭐⭐
...
### [4.4 SSR / SSG 策略](./4-4-ssr-ssg.md) ⭐⭐

## 学习路径

### 新手路径
1. 先学习 [4.2 Vue 3 运行时优化](./4-2-vue-runtime.md)，减少重渲染
2. 再学习 [4.1 Vue 3 编译优化](./4-1-vue-compile.md)，理解 PatchFlags/Block
3. 最后学习 [4.3 虚拟列表与虚拟滚动](./4-3-virtual-list.md)，解决大列表

### 进阶路径
1. 深入学习 [4.4 SSR / SSG 策略](./4-4-ssr-ssg.md)，优化首屏
2. 在实际模块（地图/视频/大屏）中验证编译+运行时组合优化
