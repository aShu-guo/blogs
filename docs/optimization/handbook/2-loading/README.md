...
### [2.1 资源加载策略](./2-1-resource-loading.md) ⭐⭐⭐
...
### [2.2 代码分割与懒加载](./2-2-code-splitting.md) ⭐⭐⭐
...
### 新手路径
1. 先学习 [2.1 资源加载策略](./2-1-resource-loading.md)，安排关键/非关键资源顺序
2. 再学习 [2.2 代码分割与懒加载](./2-2-code-splitting.md)，减少初始体积
3. 最后学习 [2.3 缓存策略](./2-3-caching.md)，提升复访体验

### 进阶路径
1. 深入学习 [2.4 CDN 与边缘计算](./2-4-cdn.md)，优化跨地域访问
2. 结合 [2.3 缓存策略](./2-3-caching.md)，构建多层缓存
3. 在项目中验证首屏链路，迭代分包和预取策略
